<%@ Page Title="" Language="C#" MasterPageFile="~/DefaulPage/Default.Master" AutoEventWireup="true" CodeBehind="TableReservation.aspx.cs" Inherits="Smart_Hotel_Restaurant.DefaulPage.TableReservation" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid img-fluid" style="background-color: white;">
        ...
        <div class="container mt-2 mb-3">
            <div>
                <center>
                    <span style="font-weight: 700; font-size: 45px;" class="text-secondary">Table Reservation
                    </span>
                </center>
            </div>
            <div>
                <ul class="nav justify-content-center mt-3 mb-3 " style="color: white; font-size: 20px;">
                    ...
                    <li class="nav-item">
                        ...
                        <asp:LinkButton ID="LnkALl" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkALl_Click" runat="server">
                      All
                        </asp:LinkButton>
                    </li>

                    <li class="nav-item">
                        <asp:LinkButton ID="LnkLuzonsss" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkLuzonsss_Click" runat="server">
                      Luzon
                        </asp:LinkButton>
                    </li>

                    <li class="nav-item">
                        <asp:LinkButton ID="LnkVisayasss" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkVisayasss_Click" runat="server">
                     Visayas
                        </asp:LinkButton>
                    </li>

                    <li class="nav-item">
                        <asp:LinkButton ID="LnkMindanaoss" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkMindanaoss_Click" runat="server">
    
                    Mindanao
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
                        <asp:LinkButton ID="LnkOnePersonssss" Visible="false" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkOnePersonssss_Click" runat="server">
    
                   1 Person
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
                        <asp:LinkButton ID="LnkTwoPersonss" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkTwoPersonss_Click" runat="server">
    
                    2 Persons
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
                        <asp:LinkButton ID="LnkFourPersonss" class="text-secondary pl-3 pr-3 nav-link" Style="font-size: 15px;" OnClick="LnkFourPersonss_Click" runat="server">
    
                     4 Persons
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
                        <asp:LinkButton ID="LnkSixPersonsss" class="nav-link text-secondary pl-3 pr-3" Style="font-size: 15px;" OnClick="LnkSixPersonsss_Click" runat="server">
                    6 Persons
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
                        <asp:LinkButton ID="lnkFamilySize" class="nav-link text-secondary pl-3 pr-3" Style="font-size: 15px;" OnClick="lnkFamilySize_Click" runat="server">
                   Family Size
                        </asp:LinkButton>
                    </li>
                    <li class="nav-item">
